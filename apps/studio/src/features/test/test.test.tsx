...
function skillRepo(): Record<string, string | null> {
  return {
    ...
    "registry/skills/notes/item.json": JSON.stringify({ slug: "notes", name: "Notes", type: "skill", description: "Takes notes.", compatibility: ["claude", "antigravity"], sourceType: "seedr" }),
