...
/** One agent's brand mark, named for hover and screen readers. */
export function CodingAgentIcon({ agent, size = 12 }: { agent: CanonicalCodingAgent; size?: number }) {
  return (
    <img
      src={CODING_AGENT_LOGOS[agent]}
      alt={AGENT_LABELS[agent]}
      data-tip={AGENT_LABELS[agent]}
      width={size}
      height={size}
