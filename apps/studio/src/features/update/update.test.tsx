...
describe("updateStore", () => {
  test("refuses synced items and only patches what changed", async () => {
    ...
    const form = { name: "Playwright", prePrompt: "", prompt: "", refreshMeta: true, label: "", description: "Drives a browser.", longDescription: LONG, compatibility: ["claude" as const], targetScope: "" as const };
